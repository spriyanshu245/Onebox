...
export const MailFeed = ({ threadId }) => {
    ...
    <>
      <div className="border-b-2 dark:border-[#33383F] border-[#E0E0E0] w-full flex justify-between px-8 py-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="dark:bg-[#1F1F1F] text-black dark:text-white border bg-white dark:border-[#343A40] flex items-center rounded-md py-2 px-3 text-sm">
      ...
      <div key ={Math.random()*8} className="overflow-y-scroll no-scrollbar h-full">
            ...
            <div className="p-4">
              <div className="flex justify-between py-4">
                <div className="space-y-2">
                  <div className="font-bold dark:text-white text-black ">{mail.subject}</div>
                  <div className="dark:text-[#AEAEAE] text-[#637381] text-sm">from: {mail.fromEmail}</div>
                  <div className="dark:text-[#AEAEAE] text-[#637381] text-sm">to: {mail.toEmail}</div>
                </div>
        ...
        <div className="mb-20 py-8 mx-8 relative flex justify-center items-center">
          <div className="h-[2px] w-full bg-[#E0E0E0] dark:bg-[#33383F]"></div>
          <div className="absolute inset-0 flex justify-center items-center">
            {" "}
            <div className="dark:bg-[#171819] bg-[#E0E0E0] text-black dark:text-white px-4 py-2 text-sm flex items-center space-x-1">
              {" "}
      ...
      <div className="mx-8">
        {showReply && (
          <ReplyModal
            ...
            fromEmail ={selectedMail[0]?.fromEmail}
          />
        )}
      </div>
      <div
